...
class JWTAuthorizationFilter @Autowired constructor(
  ...
  private val logHandler = LogHandler(JWTAuthorizationFilter::class.java)

  private val privateEndpoints =
    listOf(ApiRoutes.ChefRoutes.refreshToken, ApiRoutes.ChefRoutes.changePassword, ApiRoutes.ChefRoutes.changeUsername)
  ...
  private fun handleTokenInvalid(response: HttpServletResponse, msg: String) {
    logHandler.logResponseException(RuntimeException(msg))
